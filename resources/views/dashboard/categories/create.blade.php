...
<div class="col-lg-8 ">
    <form method="post" action="/dashboard/categories" class="mb-5">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('name') is_invalid @enderror" id="name" name="name" autofocus required value="{{ old('name') }}">
          @error('name')
        ...
        <button type="submit" class="btn btn-primary mb-auto">Create Category</button>
    </form>
</div>
