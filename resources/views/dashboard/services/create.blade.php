...
<div class="col-lg-8 ">
    <form method="post" action="/dashboard/services" class="mb-5">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('name') is_invalid @enderror" id="name" name="name" autofocus required value="{{ old('title') }}">
          @error('name')
        ...
        <button type="submit" class="btn btn-primary mb-auto">Create Service</button>
    </form>
</div>
