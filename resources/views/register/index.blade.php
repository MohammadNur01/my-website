...
<div class="row justify-content-center mb-5">
  <div class="col-lg-5">
    <main class="form-registration">
      ...
      <small class="d-block text-center mt-3">Already registered? <a href="/login" class=" text-decoration-none px-1 py-1 rounded" style="background-color: cornsilk"> Login</a></small>
    </main>
  </div>
</div>
